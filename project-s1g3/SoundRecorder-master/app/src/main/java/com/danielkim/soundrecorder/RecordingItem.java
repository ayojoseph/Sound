...
public class RecordingItem implements Parcelable {
    ...
    private int mFavourite = 0; //Flag to determine if a favourite for sorting (default 0 is not a favourite)
    ...
    public int getFavourite () { return mFavourite; }

    public void setFavourite (int fav) { mFavourite = fav; }
