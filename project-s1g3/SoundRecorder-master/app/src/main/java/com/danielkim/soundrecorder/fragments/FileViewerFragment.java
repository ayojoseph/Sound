 ...
 */
public class FileViewerFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public static FileViewerFragment newInstance(int position,int sort) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mFileViewerAdapter = new FileViewerAdapter(getActivity(), llm, sorter);
