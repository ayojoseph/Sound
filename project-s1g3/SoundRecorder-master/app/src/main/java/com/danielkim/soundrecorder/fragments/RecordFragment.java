...
public class RecordFragment extends Fragment {
    ...
    private void onRecord(boolean start){
        ...
        if (start) {
            ...
            intent.putExtra("string param 1",mfilename);
            getActivity().startService(intent);
            //keep screen on while recording
            getActivity().getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);

            mRecordingPrompt.setText(getString(R.string.record_in_progress) + ".");
//            mRecordingPrompt.setText(mfilename);
            mRecordPromptCount++;
...
//            mRecordingPrompt.setText(mfilename);
//            Intent intent2 = new Intent(getActivity(), RecordingService.class);
//            intent2.putExtra(mfilename, "String for the Service");
...
//        final EditText input = new EditText(this);
        ...
        renameFileBuilder.setTitle("Enter File Name: ");
...
//                            mfilename = value;
                                MainActivity.rfname = value;
//                            rename(position, value);
//                            mDatabase.addRecording(value,mFilePath,mElapsedMillis);
        ...
        alert = renameFileBuilder.create();
        alert.show();
    }
}